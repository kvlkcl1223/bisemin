 ...
 * 3. PID 也可以使用整数或定点数
 */
#define PANEL_TEMP_MIN_X10 -100 // 最低设定温度：-10.0℃
...
#define PANEL_JUMP_RAMP_X10_PER_MIN 50
    ...
    typedef struct
    {
        ...
        /*
         * 参数设置模式下, 先展示参数缩写名的时间戳。
         * 切换到新参数后先显示名称 1 秒, 然后自动切回数值。
         */
        bool param_show_name;
        uint32_t param_show_tick_ms;
    ...
    /* 全局面板对象, 供 main.c 和 FreeRTOS 任务访问 */
