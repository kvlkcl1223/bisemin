...
/*
 * Cell stacking route configuration.
 * Indexes are zero-based: temp 0..3 means sensor CH1..CH4, drv 0..4 means
 * DRV1..DRV5. The PID output drives the outer Peltier; the inner Peltier
 * follows it by the configured ratio.
 */
