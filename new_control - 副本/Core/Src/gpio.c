...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED1_Pin|LED2_Pin|SLEEP1_Pin|SLEEP2_Pin
  ...
  /*Configure GPIO pins : LED1_Pin LED2_Pin SLEEP1_Pin SLEEP2_Pin
                           SLEEP3_Pin SENSOR_CS2_Pin DIR2_Pin DIR3_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|SLEEP1_Pin|SLEEP2_Pin
                          |SLEEP3_Pin|SENSOR_CS2_Pin|DIR2_Pin|DIR3_Pin;
  ...
  /*Configure GPIO pins : WDFLT1_Pin INT2_Pin */
  GPIO_InitStruct.Pin = WDFLT1_Pin|INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : WDFLT2_Pin WDFLT3_Pin WDFLT4_Pin INT1_Pin */
  GPIO_InitStruct.Pin = WDFLT2_Pin|WDFLT3_Pin|WDFLT4_Pin|INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : DIR4_Pin DIR5_Pin SLEEP4_Pin SLEEP5_Pin
                           CS1_Pin CS2_Pin CS3_Pin CS4_Pin */
  GPIO_InitStruct.Pin = DIR4_Pin|DIR5_Pin|SLEEP4_Pin|SLEEP5_Pin
                          |CS1_Pin|CS2_Pin|CS3_Pin|CS4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
